...
class CollectorService(BaseService):
    ...
    def collect(self, params):
        ...
        shd_manager = self.locator.get_manager('ServiceHealthDashboardManager')

        for event_resource in shd_manager.collect_resources(params):
            yield event_resource.to_primitive()
